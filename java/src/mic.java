...
public class mic {
    ...
    public void mutemic() {
        try {
            ...
            System.out.println("marche pas :( n°1"+e);
        }
        try {
            Runtime run = Runtime.getRuntime();
            Process process = run.exec("powershell \"script/micro.ps1\"");
        }catch (IOException e) {
            System.out.println("marche pas :( n°2"+e);
        }
    }
    public void unmutemic() {
        try {
            ...
            System.out.println("marche pas :( n°3"+e);
        }
        try {
            Runtime run = Runtime.getRuntime();
            Process process = run.exec("powershell \"script/micro.ps1\"");
        }catch (IOException e) {
            System.out.println("marche pas :( n°4"+e);
        }
    }
